...
const EN: Strings = {
  ...
  subtitleEnvVars: "Key-value env vars saved to config.env.vars in ~/.linmo/linmo.json.",
...
const ZH: Strings = {
  ...
  subtitleConfig: "安全编辑 ~/.linmo/linmo.json。",
  subtitleEnvVars: "Key-Value 环境变量，保存至 ~/.linmo/linmo.json 的 env.vars。",
  ...
  overviewGatewayToken: "网关令牌 (访问远程需从linmo.json中获取)",
