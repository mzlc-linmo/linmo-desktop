...
本文档基于 Gateway 中 `hooks.go` 的实际实现，以及官方文档 [`https://docs.linmo.ai/zh-CN/automation/webhook`](https://docs.linmo.ai/zh-CN/automation/webhook) 的约定，说明 Linmo Gateway 对外提供的 Webhook 接口：
...
综合 [`https://docs.linmo.ai/zh-CN/automation/webhook`](https://docs.linmo.ai/zh-CN/automation/webhook) 的官方建议与本仓库实现：
