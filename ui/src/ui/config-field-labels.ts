...
const CONFIG_FIELD_LABELS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "agents.defaults.knowledge": "Knowledge Vault",
    "agents.defaults.knowledge.vaultDir": "Vault Directory Path",
    memory: "Memory",
  ...
  zh: {
    ...
    "gateway.auth.token": "网关令牌(访问远程服务需要从~/.linmo/linmo.json中获取)",
    ...
    "agents.defaults.knowledge": "知识库 Vault",
    "agents.defaults.knowledge.vaultDir": "Vault 目录路径",
    memory: "记忆",
    "memory.backend": "记忆后端",
